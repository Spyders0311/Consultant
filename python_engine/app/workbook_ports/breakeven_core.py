...
def contribution_margin_summary(
    ...
    *,
    ...
    contribution_margin_pct = pct(contribution_margin, revenue)
...
def office_tool_breakeven(
    ...
    *,
    ...
    gross_margin_percent = pct(gross_margin_amount, annual_revenue) or 0.0
...
def sales_increase_profit_impact(
    ...
    return {
        ...
        "salesChange": round_money(sales_change),
        "currentProfit": round_money(current_profit),
        "newProfit": round_money(new_profit),
        "profitChange": round_money(profit_change),
        "profitChangePct": pct(profit_change, abs(current_profit) if current_profit else current_profit or 1),
