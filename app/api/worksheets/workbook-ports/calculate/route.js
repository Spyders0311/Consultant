...
export async function POST(request) {
  ...
  try {
    ...
    const upstream = await fetch(`${PYTHON_ENGINE_URL}/api/v1/worksheets/workbook-ports/calculate`, {
      method: 'POST',
    ...
    return NextResponse.json({ ok: false, error: 'Unable to reach calculation engine.' }, { status: 502 });
  }
}
