...
export async function buildResultsPdf({ model, result, consultant }) {
  ...
  if (model === 'breakeven') {
    y = drawSummaryRow(page, fonts, 'Formula Basis', text(result?.formulaBasis), y);
    ...
    y = drawSummaryRow(page, fonts, 'Variable Costs', currency(result?.variableCostsAmount), y);
    y = drawSummaryRow(page, fonts, 'Fixed Costs', currency(result?.fixedCostsAmount), y);
    y = drawSummaryRow(page, fonts, 'Breakeven Revenue', currency(result?.breakevenRevenue), y);
    y = drawSummaryRow(page, fonts, 'Breakeven Days', text(result?.breakevenDays), y);
