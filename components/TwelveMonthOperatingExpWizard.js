...
export default function TwelveMonthOperatingExpWizard({ clientId }) {
  return (
    <TwelveMonthAnalysisWizard
      clientId={clientId}
      config={TWELVE_MONTH_ANALYSIS_CONFIGS['12-month-analysis-operating-exp']}
    />
  );
}
